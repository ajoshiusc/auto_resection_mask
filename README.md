...
# Standalone binary (Windows, Linux and Mac)
 - Standalone binaries for this module are available: [Windows](https://neuroimage.usc.edu/bst/getupdate.php?d=bst_resection_identification_win64.zip), [Linux](https://neuroimage.usc.edu/bst/getupdate.php?d=bst_resection_identification_linux64.zip), Mac ([Intel](https://neuroimage.usc.edu/bst/getupdate.php?d=bst_resection_identification_mac64.zip) | [Apple Silicon](https://neuroimage.usc.edu/bst/getupdate.php?d=bst_resection_identification_mac64arm.zip)).
